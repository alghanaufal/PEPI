  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <p class="brand-link">
        ...
        <span class="brand-text font-weight-light">PEPI</span>
      </p>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="<?php echo base_url() ?>buku/status" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Status Buku</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="<?php echo base_url() ?>buku/bukurusak" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Buku Rusak</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="<?php echo base_url() ?>buku/jumlah_buku" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Buku</p>
                  </a>
                </li>
